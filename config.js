...
const CONFIG = {
    ...
    backgrounds: {
        // 首页区域背景媒体（支持视频和图片）
        heroBackground: {
            url: "https://s3plus.meituan.net/opapisdk/op_ticket_885190757_1758369338944_qdqqd_o0s5v7.avif",
            type: "auto", // "auto" | "video" | "image" - auto会自动检测文件类型
            fallback: "https://s3plus.meituan.net/opapisdk/op_ticket_885190757_1758390540565_qdqqd_uxwkku.jpg" // 备用图片
        },
        ...
        demoVideoBackground: {
            url: "https://s3plus.meituan.net/opapisdk/op_ticket_885190757_1758369338944_qdqqd_o0s5v7.avif",
            type: "auto", // "auto" | "video" | "image" - auto会自动检测文件类型
            fallback: "https://s3plus.meituan.net/opapisdk/op_ticket_885190757_1758388826873_qdqqd_0ygyxf.jpg" // 备用图片
        },
    ...
    content: {
        // 网站标题 - 显示在浏览器标签页的标题
        siteTitle: "栖 梦 谷 - 百业风云录",
        
        // 首页域文本 - 首屏显示的主要标题和副标题
        hero: {
            title: "栖 梦 谷",                                    // 主标题
            subtitle: "剑未配妥，身已江湖；心若栖梦，皆是侠途!"      // 副标题/描述
        },
        ...
        // 关于我们区域文本 - 关于我们区域显示的各种信息
        about: {
            // 区域标题和副标题
            title: "加入我们",
            subtitle1: "燕云十六声百业搜索",
            subtitle2: "栖 梦 谷",
            subtitle3: "百业ID: 10553464",
        ...
        footer: {
            ...
            sections: {
                main: {
                    title: "栖 梦 谷",
                    description: "剑未配妥，身已江湖；心若栖梦，皆是侠途!"
                },
                join: {
                    title: "加入我们",
                    description: "百业ID: 10553464"
                },
                follow: {
                    title: "技术支持",
                    socialLinks: [
            ...
            // 底部版权信息
            copyright: "&copy; 2025 栖梦谷 ▪ 保留所有权利."
        }
    }
};
